...
--
-- CONTENTS AND WHY (each row deterministic; provenance = the archived migration that first shipped it):
...
--        private.google_sync_cron_secret         (id, secret)                  -> (1, '')
...
-- 1. US area-code -> state reference (324 rows)
INSERT INTO public.area_code_mapping (area_code, state) VALUES
  -- Alabama
  ...
  ('628', 'California'), ('650', 'California'), ('657', 'California'), ('669', 'California'),
  ('707', 'California'), ('714', 'California'), ('747', 'California'), ('760', 'California'),
  ('805', 'California'), ('818', 'California'), ('820', 'California'), ('831', 'California'),
  ...
  ('407', 'Florida'), ('448', 'Florida'), ('561', 'Florida'), ('689', 'Florida'), ('727', 'Florida'),
  ('754', 'Florida'), ('772', 'Florida'), ('786', 'Florida'), ('813', 'Florida'), ('850', 'Florida'),
...
INSERT INTO private.twilio_provisioning_config (id, supabase_url, service_role_key) VALUES (1, '', '') ON CONFLICT (id) DO NOTHING;
