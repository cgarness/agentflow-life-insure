-- =============================================================
-- Migration: Fix Enterprise Waterfall Queue columns
-- Date: 2026-04-06
-- Purpose: Recreate get_enterprise_queue_leads RPC with correct
--          column order (and user_id inclusion) to satisfy the
--          RETURNS SETOF public.campaign_leads constraint.
-- =============================================================
...
BEGIN
  ...
  WHERE 
    ...
    (v_max_att IS NULL OR cl.call_attempts < v_max_att)
