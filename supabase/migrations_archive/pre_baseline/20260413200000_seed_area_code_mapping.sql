-- ============================================================
-- Seed: area_code_mapping — all assigned US NANP area codes
-- Adds UNIQUE constraint on area_code so ON CONFLICT is keyed.
-- Safe to re-run: ON CONFLICT (area_code) DO NOTHING.
-- ============================================================

ALTER TABLE area_code_mapping
  ADD CONSTRAINT area_code_mapping_area_code_key UNIQUE (area_code);

-- area_code_mapping seed (US area codes)
INSERT INTO area_code_mapping (area_code, state) VALUES
  -- Alabama
