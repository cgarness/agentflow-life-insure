    ...
    <NavLink
      ...
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium sidebar-transition group relative
        ${isActive
          ...
          : variant === "warning" ? "text-amber-500 hover:bg-amber-600/10 hover:text-amber-400" : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
        }
