...
import {
  ChevronLeft, ChevronRight, ArrowLeft, ShieldAlert, FlaskConical, ClipboardList,
      ...
      <>
        ...
        {isSuperAdmin && (
          <MainNavItem
            ...
            path="/ai-testing"
            collapsed={collapsed}
            isActive={location.pathname === "/ai-testing"}
            variant="warning"
            onClick={() => setMobileOpen(false)}
          />
        )}
        ...
        {isSuperAdmin && (
          <MainNavItem
            ...
            path="/project-status"
            collapsed={collapsed}
            isActive={location.pathname === "/project-status"}
            variant="warning"
            onClick={() => setMobileOpen(false)}
          />
        )}
