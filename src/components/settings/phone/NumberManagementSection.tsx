      ...
      >
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>Filters are ready; live inventory search ships in Phase&nbsp;9.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-1">
                    <Select value={searchPatternType} onValueChange={(v: any) => setSearchPatternType(v)}>
              ...
              <DisabledWithTip label={upgradeTip}>
                <Button type="button" className="w-full pointer-events-none opacity-50" disabled>
                  <Search className="w-4 h-4 mr-2" />
                  Search available numbers
                </Button>
              </DisabledWithTip>
              <p className="text-xs text-muted-foreground text-center">
                Twilio-backed search and checkout return in Phase&nbsp;9. You can still add numbers you already own with{" "}
