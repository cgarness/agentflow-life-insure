...
const CallMonitoring: React.FC = () => {
  ...
  const handleAction = (action: string) => {
    toast.info("Call monitoring requires Telnyx Call Control API — coming in a future update.");
  };
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-3 bg-primary/5 border border-primary/20 rounded-xl p-4">
        ...
        <p className="text-sm text-foreground">
          Listen, Whisper, and Barge require Telnyx Call Control API integration. Full functionality coming soon.
        </p>
      </div>
