          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className={`text-sm px-3 py-1 rounded-full font-semibold ${policyTypeBadge[client.policyType]||"bg-muted text-muted-foreground"}`}>{client.policyType}</span>
              </div>
              <p className="text-sm text-muted-foreground mt-0.5">{client.carrier} · Policy #{client.policyNumber||"—"}</p>
            </div>
          </div>
