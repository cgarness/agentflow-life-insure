                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="relative" ref={statusDropdownRef}>
                     <button
                      ...
                      className={`text-sm px-4 py-2 rounded-full font-semibold inline-flex items-center gap-1.5 cursor-pointer transition-all duration-150 ${statusBadgeColor[currentStatus]}`}
                    >
                      {currentStatus}
                      ...
                      <div className="absolute top-full left-0 mt-1 z-50 bg-background border border-border rounded-lg shadow-md py-1 min-w-[180px]">
                        {allStatuses.map(s => (
                          <button
                            ...
                            className={`w-full text-left px-4 py-2 text-sm text-foreground hover:bg-muted flex items-center gap-2 transition-all duration-150 ${currentStatus === s ? "font-semibold" : ""}`}
                          >
