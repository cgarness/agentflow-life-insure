    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          className="absolute -right-2 -top-2 hidden h-[18px] w-[18px] items-center justify-center rounded-full border border-border/60 bg-card text-muted-foreground transition-colors group-hover:flex hover:border-rose-500 hover:bg-rose-500/10 hover:text-rose-500"
        >
