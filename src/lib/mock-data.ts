...
export const mockDispositions: Disposition[] = [
  { id: "disp1", name: "Sold / Policy Issued", color: "#22C55E", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, order: 1, usageCount: 47, createdAt: now, updatedAt: now },
  { id: "disp2", name: "Call Back / Follow Up", color: "#3B82F6", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: true, appointmentScheduler: false, automationTrigger: false, order: 2, usageCount: 124, createdAt: now, updatedAt: now },
  { id: "disp3", name: "Not Interested", color: "#EF4444", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, order: 3, usageCount: 89, createdAt: now, updatedAt: now },
  { id: "disp4", name: "No Answer / Voicemail", color: "#6B7280", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, order: 4, usageCount: 213, createdAt: now, updatedAt: now },
  { id: "disp5", name: "Wrong Number / Bad Lead", color: "#F97316", isDefault: true, requireNotes: true, minNoteChars: 10, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, order: 5, usageCount: 34, createdAt: now, updatedAt: now },
  { id: "disp6", name: "Interested", color: "#EAB308", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, order: 6, usageCount: 67, createdAt: now, updatedAt: now },
];
