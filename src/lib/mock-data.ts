...
export const mockLeads: Lead[] = [
  { id: "l1", firstName: "John", lastName: "Martinez", phone: "(555) 123-4567", email: "john.m@email.com", state: "FL", status: "Hot", leadSource: "Facebook Ads", leadScore: 9, age: 42, dateOfBirth: "1983-05-12", healthStatus: "Preferred", bestTimeToCall: "Morning", assignedAgentId: "u1", lastContactedAt: new Date(Date.now() - 1 * 86400000).toISOString(), createdAt: "2025-01-15T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l2", firstName: "Sarah", lastName: "Williams", phone: "(555) 234-5678", email: "sarah.w@email.com", state: "TX", status: "Interested", leadSource: "Google Ads", leadScore: 7, age: 35, dateOfBirth: "1990-08-23", healthStatus: "Standard", bestTimeToCall: "Afternoon", assignedAgentId: "u2", lastContactedAt: new Date(Date.now() - 5 * 86400000).toISOString(), createdAt: "2025-01-18T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l3", firstName: "Mike", lastName: "Johnson", phone: "(555) 345-6789", email: "mike.j@email.com", state: "CA", status: "New", leadSource: "Direct Mail", leadScore: 5, age: 50, dateOfBirth: "1975-11-02", healthStatus: "Preferred Plus", bestTimeToCall: "Evening", assignedAgentId: "u3", lastContactedAt: new Date(Date.now() - 12 * 86400000).toISOString(), createdAt: "2025-02-01T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l4", firstName: "Lisa", lastName: "Park", phone: "(555) 456-7890", email: "lisa.p@email.com", state: "NY", status: "Follow Up", leadSource: "Referral", leadScore: 8, age: 38, dateOfBirth: "1987-03-15", healthStatus: "Standard", bestTimeToCall: "Morning", assignedAgentId: "u1", lastContactedAt: new Date(Date.now() - 6 * 86400000).toISOString(), createdAt: "2025-01-10T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l5", firstName: "Tom", lastName: "Harris", phone: "(555) 567-8901", email: "tom.h@email.com", state: "OH", status: "Contacted", leadSource: "Webinar", leadScore: 6, age: 45, dateOfBirth: "1980-07-19", healthStatus: "Substandard", bestTimeToCall: "Afternoon", assignedAgentId: "u4", lastContactedAt: new Date(Date.now() - 3 * 86400000).toISOString(), createdAt: "2025-01-20T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l6", firstName: "Amy", lastName: "Zhang", phone: "(555) 678-9012", email: "amy.z@email.com", state: "WA", status: "Closed Won", leadSource: "Facebook Ads", leadScore: 10, age: 30, dateOfBirth: "1995-01-30", healthStatus: "Preferred", bestTimeToCall: "Morning", assignedAgentId: "u5", lastContactedAt: new Date(Date.now() - 0 * 86400000).toISOString(), createdAt: "2025-01-05T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l7", firstName: "David", lastName: "Brown", phone: "(555) 789-0123", email: "david.b@email.com", state: "FL", status: "Not Interested", leadSource: "Google Ads", leadScore: 3, age: 55, dateOfBirth: "1970-12-05", healthStatus: "Substandard", bestTimeToCall: "Evening", assignedAgentId: "u2", lastContactedAt: new Date(Date.now() - 18 * 86400000).toISOString(), createdAt: "2025-01-12T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l8", firstName: "Maria", lastName: "Lopez", phone: "(555) 890-1234", email: "maria.l@email.com", state: "AZ", status: "Hot", leadSource: "Referral", leadScore: 9, age: 40, dateOfBirth: "1985-09-08", healthStatus: "Preferred Plus", bestTimeToCall: "Afternoon", assignedAgentId: "u3", lastContactedAt: new Date(Date.now() - 2 * 86400000).toISOString(), createdAt: "2025-02-05T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l9", firstName: "Robert", lastName: "Taylor", phone: "(555) 901-2345", email: "robert.t@email.com", state: "GA", status: "New", leadSource: "Direct Mail", leadScore: 4, age: 48, dateOfBirth: "1977-04-22", healthStatus: "Standard", bestTimeToCall: "Morning", assignedAgentId: "u1", lastContactedAt: new Date(Date.now() - 9 * 86400000).toISOString(), createdAt: "2025-02-20T10:00:00Z", updatedAt: new Date().toISOString() },
  { id: "l10", firstName: "Jennifer", lastName: "Davis", phone: "(555) 012-3456", email: "jennifer.d@email.com", state: "NC", status: "Interested", leadSource: "Webinar", leadScore: 7, age: 33, dateOfBirth: "1992-06-14", healthStatus: "Preferred", bestTimeToCall: "Evening", assignedAgentId: "u2", lastContactedAt: new Date(Date.now() - 7 * 86400000).toISOString(), createdAt: "2025-02-10T10:00:00Z", updatedAt: new Date().toISOString() },
];
...
export const mockDispositions: Disposition[] = [
  { id: "disp1", name: "Sold / Policy Issued", color: "#22C55E", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, convertToClient: true, order: 1, usageCount: 47, createdAt: now, updatedAt: now },
  { id: "disp2", name: "Call Back / Follow Up", color: "#3B82F6", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: true, appointmentScheduler: false, automationTrigger: false, convertToClient: false, order: 2, usageCount: 124, createdAt: now, updatedAt: now },
  { id: "disp3", name: "Not Interested", color: "#EF4444", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, convertToClient: false, order: 3, usageCount: 89, createdAt: now, updatedAt: now },
  { id: "disp4", name: "No Answer / Voicemail", color: "#6B7280", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, convertToClient: false, order: 4, usageCount: 213, createdAt: now, updatedAt: now },
  { id: "disp5", name: "Wrong Number / Bad Lead", color: "#F97316", isDefault: true, requireNotes: true, minNoteChars: 10, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, convertToClient: false, order: 5, usageCount: 34, createdAt: now, updatedAt: now },
  { id: "disp6", name: "Interested", color: "#EAB308", isDefault: true, requireNotes: false, minNoteChars: 0, callbackScheduler: false, appointmentScheduler: false, automationTrigger: false, convertToClient: false, order: 6, usageCount: 67, createdAt: now, updatedAt: now },
];
