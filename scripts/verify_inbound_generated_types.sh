...
for f in \
  ...
  "$ROOT/supabase/migrations/20260911000200_inbound_routing_v2_settings.sql" \
  "$ROOT/supabase/migrations/20260911000300_inbound_route_attempts_d13_and_recovery.sql" \
  "$ROOT/supabase/migrations/20260911000400_inbound_voicemails.sql"; do
